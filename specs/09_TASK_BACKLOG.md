...
- [x] Add test runner
- [x] Add `/specs` folder and copy Markdown specs
...
- [x] Define Kline, FuturesMetric, FactorScores, ScoreSnapshotView, TagView, EventLog types
- [x] Create `lib/data/mockData.ts`
- [x] Add at least 12 symbols
- [x] Include scenarios: outperformer, hidden setup, downside sweep, upside sweep, OI build-up, overheated funding, low liquidity, neutral
